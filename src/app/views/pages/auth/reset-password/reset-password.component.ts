...
export class ResetPasswordComponent implements OnInit, OnDestroy {
 ...
 ngOnInit() {
   ...
   this.resetPasswordToken = this.route.snapshot.queryParamMap.get('reset_password_token');
 }
 ...
 submit() {
   ...
   this.authService.resetPassword(password,this.resetPasswordToken).pipe(
     tap(response => {
       if (response) {
